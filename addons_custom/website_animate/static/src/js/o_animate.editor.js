odoo.define('website_animate.snippets.editor', function (require) {
'use strict';
...
snippet_editor.Class.include({
  ...
  // Duration
  options.registry.o_animate_duration = options.Class.extend({
    select_class: function(type, value, $li){
      this._super(type, value, $li);
  ...
  // Delay
  options.registry.o_animate_delay = options.Class.extend({
    select_class: function(type, value, $li){
      this._super(type, value, $li);
      var self = this;
