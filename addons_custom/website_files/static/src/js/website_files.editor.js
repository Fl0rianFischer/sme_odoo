odoo.define('website_files.file', function (require) {
'use strict';
    ...
    ajax.loadXML('/website_files/static/src/xml/website_files.editor.xml?'+Math.random(), qweb);
    ...
    widget.MediaDialog.include({
        start: function () {
            var self = this;
            this.fileDialog = new FileDialog(this, this.media, this.options);
    ...
    var FileDialog = Widget.extend({
        template: 'web_editor.dialog.file',
        ...
        display_attachments: function () {
            ...
            this.$('.existing-attachments-files').replaceWith(
                qweb.render(
                    'web_editor.dialog.file.existing.content', {cur_records: cur_records}));
            this.parent.$('.pager')
